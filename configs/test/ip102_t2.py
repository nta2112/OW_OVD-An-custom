...
# open world setting for Task 2 (Known: 13 classes)
prev_intro_cls = 7
cur_intro_cls = 6
...
coco_train_dataset = dict(
        ...
        dataset=dict(
            ...
            metainfo=dict(classes=class_names[:13]),  # Learn the first 13 classes for T2
...
# Clean up all temporary variables from config namespace to avoid deepcopy/pickle errors
